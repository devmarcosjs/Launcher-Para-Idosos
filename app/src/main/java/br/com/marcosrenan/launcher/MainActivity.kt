package br.com.marcosrenan.launcher

// Projeto criado por Marcos Renan para Atividade Extensionista UNINTER
//RU : 3988325
...
import br.com.marcosrenan.launcher.R
...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPreferences = getSharedPreferences("launcher_preferences", MODE_PRIVATE)
    ...
    private fun promptToSetDefaultLauncher() {
        ...
        if (intent.resolveActivity(packageManager) != null) {
            ...
            Toast.makeText(
                this,
                "Por favor defina o iniciador manualmente nas configurações do dispositivo.",
                Toast.LENGTH_LONG
            ).show()
        }
    }
    ...
    private fun pickImageFromGallery() {
        ...
        if (intent.resolveActivity(packageManager) != null) {
            ...
            Toast.makeText(this, "Nenhum aplicativo encontrado para selecionar imagens", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun startMenuOrDrag(view: View, index: Int): Boolean {
        ...
        }, 500) // Delay antes de mostrar o menu
